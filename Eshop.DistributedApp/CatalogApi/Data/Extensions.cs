...
public class DatabaseSeeder
{
    ...
    [
        ...
        new Product { Name="Smart Watch", Description="Fitness tracker with heart rate monitor and GPS.", Price=89.99m, ImageUrl="https://m.media-amazon.com/images/I/61Npi-ZsJIL._AC_UL320_.jpg"},
        ...
        new Product { Name="Laptop Backpack", Description="Anti-theft backpack with USB charging port and laptop compartment.", Price=42.99m, ImageUrl="https://m.media-amazon.com/images/I/71HJZOgsvtL._AC_UL320_.jpg"},
        new Product { Name="Wireless Mouse", Description="Ergonomic wireless mouse with adjustable DPI settings.", Price=24.99m, ImageUrl="https://m.media-amazon.com/images/I/61qNHYBaOZL._AC_UL320_.jpg"}
    ];
}
